...
[![Version](https://img.shields.io/badge/version-v0.18.1-gold)](./CHANGELOG.md)
[![License](https://img.shields.io/badge/license-ISC-blue.svg)](./LICENSE)

**最新动态**：v0.18.1 设置超时修复——修复后台设置数字输入过快保存问题（改为 onBlur 保存），修复后端 3 处配置读取路径错误（使用 app_data_dir 而非 current_dir），用户设置的超时时间现在真正生效。v0.18.0 后台资产深度审计 × 智能创作流程全面优化——发现并修复系统级矛盾（默认续写路径 TimeSliced 绕过约 90% 后台资产）。4 项断环修复，4 项核心优化，3 项死代码清理，3 项架构优化。`cargo test --lib` 444/444 通过。
