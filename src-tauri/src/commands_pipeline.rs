...
pub async fn get_chapter_blueprint(
    ...
    let repo = BlueprintRepository::new(pool.inner().clone());
    repo.get_by_chapter(&story_id, chapter_number).map_err(|e| e.to_string())
}
...
pub async fn update_blueprint(
    ...
    let repo = BlueprintRepository::new(pool.inner().clone());
    repo.update(&blueprint_id, req).map_err(|e| e.to_string())
}
...
pub async fn delete_blueprint(
    ...
    let repo = BlueprintRepository::new(pool.inner().clone());
    repo.delete(&blueprint_id).map_err(|e| e.to_string())
}
...
pub async fn get_draft(
    ...
    let repo = DraftRepository::new(pool.inner().clone());
    repo.get_by_id(&draft_id).map_err(|e| e.to_string())
}
...
pub async fn get_story_chapter_drafts(
    ...
    let repo = DraftRepository::new(pool.inner().clone());
    repo.get_by_story_chapter(&story_id, chapter_number).map_err(|e| e.to_string())
}
...
pub async fn get_latest_draft(
    ...
    let repo = DraftRepository::new(pool.inner().clone());
    repo.get_latest_by_chapter(&story_id, chapter_number).map_err(|e| e.to_string())
}
...
pub async fn get_finalized_draft(
    ...
    let repo = DraftRepository::new(pool.inner().clone());
    repo.get_finalized_by_chapter(&story_id, chapter_number).map_err(|e| e.to_string())
}
...
pub async fn update_draft_status(
    ...
    let repo = DraftRepository::new(pool.inner().clone());
    let status = status.parse().map_err(|e: String| e)?;
    repo.update_status(&draft_id, status).map_err(|e| e.to_string())
}
...
pub async fn update_draft_content(
    ...
    let repo = DraftRepository::new(pool.inner().clone());
    repo.update_content(&draft_id, &content, word_count).map_err(|e| e.to_string())
}
...
pub async fn delete_draft(
    ...
    let repo = DraftRepository::new(pool.inner().clone());
    repo.delete(&draft_id).map_err(|e| e.to_string())
}
...
pub async fn create_revision(
    ...
    let revision_type = revision_type.parse().map_err(|e: String| e)?;
    repo.create(
...
pub async fn get_revision(
    ...
    let repo = RevisionRepository::new(pool.inner().clone());
    repo.get_by_id(&revision_id).map_err(|e| e.to_string())
}
...
pub async fn update_revision_status(
    ...
    let repo = RevisionRepository::new(pool.inner().clone());
    let status = status.parse().map_err(|e: String| e)?;
    repo.update_status(&revision_id, status).map_err(|e| e.to_string())
}
...
pub async fn delete_revision(
    ...
    let repo = RevisionRepository::new(pool.inner().clone());
    repo.delete(&revision_id).map_err(|e| e.to_string())
}
...
pub async fn get_draft_reviews(
    draft_id: String,
    pool: State<'_, DbPool>,
) -> Result<Vec<PipelineReview>, String> {
    let repo = PipelineReviewRepository::new(pool.inner().clone());
    repo.get_by_draft(&draft_id).map_err(|e| e.to_string())
}
...
pub async fn get_latest_pipeline_review(
    draft_id: String,
    pool: State<'_, DbPool>,
) -> Result<Option<PipelineReview>, String> {
    let repo = PipelineReviewRepository::new(pool.inner().clone());
    repo.get_latest_by_draft(&draft_id).map_err(|e| e.to_string())
}
...
pub async fn delete_pipeline_review(
    ...
    let repo = PipelineReviewRepository::new(pool.inner().clone());
    repo.delete(&review_id).map_err(|e| e.to_string())
}
...
pub async fn get_post_process_run(
    run_id: String,
    pool: State<'_, DbPool>,
) -> Result<Option<PostProcessRun>, String> {
    let repo = PostProcessRepository::new(pool.inner().clone());
    repo.get_run_by_id(&run_id).map_err(|e| e.to_string())
}
...
pub async fn get_story_chapter_post_process_runs(
    ...
    chapter_number: i32,
    pool: State<'_, DbPool>,
) -> Result<Vec<PostProcessRun>, String> {
    let repo = PostProcessRepository::new(pool.inner().clone());
    repo.get_runs_by_story_chapter(&story_id, chapter_number).map_err(|e| e.to_string())
}
...
pub async fn update_post_process_run_status(
    ...
    let repo = PostProcessRepository::new(pool.inner().clone());
    let status = status.parse().map_err(|e: String| e)?;
    repo.update_run_status(&run_id, status, error_message.as_deref()).map_err(|e| e.to_string())
}
...
pub async fn get_post_process_steps(
    run_id: String,
    pool: State<'_, DbPool>,
) -> Result<Vec<PostProcessStep>, String> {
    let repo = PostProcessRepository::new(pool.inner().clone());
    repo.get_steps_by_run(&run_id).map_err(|e| e.to_string())
}
...
pub async fn delete_post_process_run(
    ...
    let repo = PostProcessRepository::new(pool.inner().clone());
    repo.delete_run(&run_id).map_err(|e| e.to_string())
}
...
pub async fn get_story_llm_calls(
    ...
    let repo = LlmCallRepository::new(pool.inner().clone());
    repo.get_by_story(&story_id, limit).map_err(|e| e.to_string())
}
...
pub async fn get_llm_call_stats(
    story_id: String,
    pool: State<'_, DbPool>,
) -> Result<LlmCallStats, String> {
    let repo = LlmCallRepository::new(pool.inner().clone());
    let (count, total_tokens, total_cost) = repo.get_stats_by_story(&story_id).map_err(|e| e.to_string())?;
...
pub async fn update_character_state(
    ...
    repo.update_character_state(&character_id, &state).map_err(|e| e.to_string())
}
...
pub async fn batch_update_character_states(
    ...
    repo.batch_update_states(&updates_ref).map_err(|e| e.to_string())
}
...
pub async fn get_character_state(
    character_id: String,
    pool: State<'_, DbPool>,
) -> Result<Option<CharacterState>, String> {
    let repo = CharacterRepository::new(pool.inner().clone());
    repo.get_character_state(&character_id).map_err(|e| e.to_string())
}
