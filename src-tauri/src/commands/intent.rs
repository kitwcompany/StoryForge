...
pub async fn parse_intent(user_input: String, app_handle: AppHandle) -> Result<crate::intent::Intent, String> {
...
) -> Result<crate::intent::IntentExecutionResult, String> {
...
#[tauri::command(rename_all = "snake_case")]
pub async fn record_feedback(request: RecordFeedbackRequest) -> Result<Vec<LearningPoint>, AppError> {
