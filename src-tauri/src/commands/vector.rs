...
pub async fn search_similar(story_id: String, query: String, top_k: Option<usize>) -> Result<Vec<SearchResult>, String> {
...
#[tauri::command(rename_all = "snake_case")]
pub async fn text_search_vectors(story_id: String, query: String, top_k: Option<usize>) -> Result<Vec<SearchResult>, String> {
    let store = VECTOR_STORE.get().ok_or("Vector store not initialized")?;
...
#[tauri::command(rename_all = "snake_case")]
pub async fn hybrid_search_vectors(story_id: String, query: String, top_k: Option<usize>) -> Result<Vec<SearchResult>, String> {
    use crate::embeddings::embed_text_async;
...
#[tauri::command(rename_all = "snake_case")]
pub async fn embed_chapter(chapter_id: String, content: String) -> Result<(), String> {
    use crate::embeddings::embed_text_async;
